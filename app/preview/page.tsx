...
/** 監修者ブロック＝コンパクトなカード（監修者タイトル・丸画像・テキスト）。全体1.3倍・テキストbold・株式会社日本提携支援 代表取締役は更に1.2倍。 */
function getSupervisorBlockHtml(): string {
  const imgUrl = SUPERVISOR_FACE_IMAGE_URL
  return `
<div style="max-width:780px;margin:31px auto 42px;background:#f3f4f6;border-radius:13px;padding:18px 23px;">
  ...
  <div style="display:flex;gap:16px;align-items:center;">
    <img src="${imgUrl}" alt="大野駿介" style="width:128px;height:128px;border-radius:50%;object-fit:cover;object-position:center 25%;flex-shrink:0;display:block;" />
